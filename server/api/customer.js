...
// utils
const CryptoUtil = require('../utils/CrytoUtil');
...
router.get('/products/brand/:bid', async function (req, res) {
    const _bid = req.params.bid;
    const brands = await ProductDAO.selectByBrandID(_bid);
    res.json(brands);
})
